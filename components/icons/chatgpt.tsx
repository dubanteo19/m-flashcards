...
export function ChatGPTIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            <use href="#openai-a" transform="rotate(60 1203 1203)" />
            <use href="#openai-a" transform="rotate(120 1203 1203)" />
            <use href="#openai-a" transform="rotate(180 1203 1203)" />
            <use href="#openai-a" transform="rotate(240 1203 1203)" />
            <use href="#openai-a" transform="rotate(300 1203 1203)" />
        </svg>
    );
}