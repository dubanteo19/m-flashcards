...
export default function CollectionForm({
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      ...
      form.setValue("jsonInput", JSON.stringify(cards, null, 2));
    } catch (e) {
      ...
      <div className="grid gap-4">
        <div className="flex justify-between items-center gap-4">
          ...
          <PublicSelector
            ...
            onSelect={(v) => form.setValue("isPublished", v)}
          />
        </div>
        <Controller
          name="title"
      ...
      <Tabs defaultValue="ai">
        ...
        <TabsContent value="ai" className="space-y-4">
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <Switch
                      ...
                      data-invalid={fieldState.invalid}
                    />
                    <FieldLabel htmlFor="ai-mode">AI Mode</FieldLabel>
                  </Field>
                )}
              />
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field
                    ...
                    data-invalid={fieldState.invalid}
                  >
                    <FieldLabel htmlFor="wordCount">Số từ</FieldLabel>
                    <Input
                      type="number"
                      value={field.value}
                      onChange={(e) => {
          ...
          {shouldShowPromptTemplate && (
            <PromptTemplate
              onPromptChange={(v) => form.setValue("prompt", v)}
              lang={language}
        ...
        <TabsContent
          value="manual"
          className="p-8 text-center border-2 border-dashed rounded-md"
        >
          <p className="text-muted-foreground">
            Use the JSON tab for fast bulk editing.
          </p>
        </TabsContent>
      </Tabs>
