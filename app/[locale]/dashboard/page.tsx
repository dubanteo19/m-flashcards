    ...
    <div className=" container mx-auto py-10 px-4">
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="flex gap-3 flex-wrap">
          <LinkButton className="rounded-full" href={ROUTES.DASHBOARD_NEW}>
            ...
            {isLoading ? (
              ...
              collections.map((collection) => (
                <TableRow key={collection.id}>
                  ...
                  <TableCell>
                    {collection.cards_count} {t("dashboard.table.cards")}
                  </TableCell>
                  <TableCell>
                    <div>
                  ...
                  <TableCell className="text-right">
                    <ActionButton
                      ...
                      variant="outline"
                      size="sm"
                      href={ROUTES.DASHBOARD_EDIT(collection.slug)}
                    >
                      <Pencil size={14} />
                    </ActionButton>
                    <ActionButton
                      ...
                      size="sm"
                      onClick={() =>
                        setCollectionToDelete(collection.slug || null)
                      }
                    >
                      <Trash size={14} />
                    </ActionButton>
                    <ActionButton
                      ...
                      href={ROUTES.LEARN(collection.slug)}
                    >
                      <BookOpen size={14} />
                    </ActionButton>
                  </TableCell>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("dashboard.dialog.deleteTitle")}
            </AlertDialogTitle>
            <AlertDialogDescription>
